...
```python -c "
from ia_propuesta import SolicitudPuntuacion; s = SolicitudPuntuacion(poliza='POL-20260001', correo_analista='ana@usta.co', monto=1234.567, antiguedad=3, siniestros_previos=1); print(s.monto)"
```
